 ...
 */
class ToolbarBehavior(context: Context, attributeSet: AttributeSet? = null) :
    ...
    private fun getViews(child: AppBarLayout) {
        ...
        toolbar = child.findViewById(R.id.fl_appbar_container)
        toolbarTitle = toolbar.findViewById(R.id.v_toolbar_title)
